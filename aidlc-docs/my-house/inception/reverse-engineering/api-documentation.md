...
> 2026-09-09). Sticker/canvas endpoints (`/api/stickers`, `/api/players/stickers`,
> `/api/players/canvas`) are documented in `my-house-findings.md` instead, since they're the
> direct analog for this feature.
