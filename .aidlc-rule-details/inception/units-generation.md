...
- [ ] Generate `aidlc-docs/{initiative-slug}/inception/application-design/unit-of-work.md` with unit definitions and responsibilities
- [ ] Generate `aidlc-docs/{initiative-slug}/inception/application-design/unit-of-work-dependency.md` with dependency matrix
- [ ] Generate `aidlc-docs/{initiative-slug}/inception/application-design/unit-of-work-story-map.md` mapping stories to units
...
- Save as `aidlc-docs/{initiative-slug}/inception/plans/unit-of-work-plan.md`
...
- Ask: "**Unit of work plan complete. Review the plan in aidlc-docs/{initiative-slug}/inception/plans/unit-of-work-plan.md. Ready to proceed to generation?**"
...
- [ ] Read the complete plan from `aidlc-docs/{initiative-slug}/inception/plans/unit-of-work-plan.md`
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the units generation artifacts at: `aidlc-docs/{initiative-slug}/inception/application-design/`
...
- Mark Units Generation stage complete in `aidlc-docs/{initiative-slug}/aidlc-state.md`
- Update the "Current Status" section
