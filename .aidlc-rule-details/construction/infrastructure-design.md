...
- Read functional design from `aidlc-docs/{initiative-slug}/construction/{unit-name}/functional-design/`
- Read NFR design from `aidlc-docs/{initiative-slug}/construction/{unit-name}/nfr-design/` (if exists)
...
### Step 4: Store Plan
- Save as `aidlc-docs/{initiative-slug}/construction/plans/{unit-name}-infrastructure-design-plan.md`
...
- Create `aidlc-docs/{initiative-slug}/construction/{unit-name}/infrastructure-design/infrastructure-design.md`
- Create `aidlc-docs/{initiative-slug}/construction/{unit-name}/infrastructure-design/deployment-architecture.md`
- If shared infrastructure: Create `aidlc-docs/{initiative-slug}/construction/shared-infrastructure.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the infrastructure design at: `aidlc-docs/{initiative-slug}/construction/[unit-name]/infrastructure-design/`
