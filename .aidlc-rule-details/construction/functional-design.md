...
- Read unit definition from `aidlc-docs/{initiative-slug}/inception/application-design/unit-of-work.md`
- Read assigned stories from `aidlc-docs/{initiative-slug}/inception/application-design/unit-of-work-story-map.md`
...
### Step 4: Store Plan
- Save as `aidlc-docs/{initiative-slug}/construction/plans/{unit-name}-functional-design-plan.md`
...
- Create `aidlc-docs/{initiative-slug}/construction/{unit-name}/functional-design/business-logic-model.md`
- Create `aidlc-docs/{initiative-slug}/construction/{unit-name}/functional-design/business-rules.md`
- Create `aidlc-docs/{initiative-slug}/construction/{unit-name}/functional-design/domain-entities.md`
- If unit includes frontend/UI: Create `aidlc-docs/{initiative-slug}/construction/{unit-name}/functional-design/frontend-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the functional design artifacts at: `aidlc-docs/{initiative-slug}/construction/[unit-name]/functional-design/`
