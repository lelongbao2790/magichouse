...
- Read NFR requirements from `aidlc-docs/{initiative-slug}/construction/{unit-name}/nfr-requirements/`
...
### Step 4: Store Plan
- Save as `aidlc-docs/{initiative-slug}/construction/plans/{unit-name}-nfr-design-plan.md`
...
- Create `aidlc-docs/{initiative-slug}/construction/{unit-name}/nfr-design/nfr-design-patterns.md`
- Create `aidlc-docs/{initiative-slug}/construction/{unit-name}/nfr-design/logical-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR design at: `aidlc-docs/{initiative-slug}/construction/[unit-name]/nfr-design/`
